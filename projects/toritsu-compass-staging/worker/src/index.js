...
const EXPECTED = {
  // 定時制15校＋都立産業技術高専2キャンパスを足して 187 → 189（#15）
  schools: 189,
  school_stats: 1314,
  designations: 29,
  stations: 647,
  // 通学時間を「駅→区」から「駅→学校」に変えた時点で 31,703 → 103,958 に増え、
  // 高専2キャンパス分(1,288)を足して 105,123（#15）。
  // 期待値が古いままだと /health が恒久的に ok:false になり、
  // 本当に投入漏れが起きたときに気づけない。
  // ⚠️ 学校を増やしたら、この2つを seed の実数に合わせること。
  commute_times: 105123,
};
